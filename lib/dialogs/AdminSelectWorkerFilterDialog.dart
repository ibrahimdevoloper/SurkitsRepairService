...
AlertDialog adminSelectWorkerFilterDialog(BuildContext context) {
  ...
  return AlertDialog(
    ...
    content: BlocBuilder<AdminSelectWorkerForAdisplayedRequestCubit,AdminSelectWorkerForAdisplayedRequestState>(
      bloc: BlocProvider.of<AdminSelectWorkerForAdisplayedRequestCubit>(context),
