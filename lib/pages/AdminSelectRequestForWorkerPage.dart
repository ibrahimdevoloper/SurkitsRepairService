...
class AdminSelectRequestForWorkerPage extends StatelessWidget {
  ...
  AdminSelectRequestForWorkerPage({@required DateTime selectedDate,
  ...
  Widget build(BuildContext context) {
    ...
    //                               onItemClicked: () {
    //                                 BlocProvider.of<
    //                                     AdminSelectRequestForWorkerCubit>(context)
    //                                     .assignRequest(item.requestId, provider.pref);
    //                               },
    //                               request: item,
