    ...
    return BlocProvider<AdminWorkerAssignmentsCalenderCubit>(
      ...
      child: Scaffold(
        floatingActionButton: BlocBuilder<AdminWorkerAssignmentsCalenderCubit,
            AdminWorkerAssignmentsCalenderState>(builder: (context, snapshot) {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => AdminSelectRequestForWorkerPage(
                    assignedRequests: cubit.requests[cubit.selectedDay] != null
                        ? cubit.requests[cubit.selectedDay]
        ...
        body: Column(
          children: [
            Stack(
              children: [
                BlueGradientAppBar(TextPair('Worker Calender', 'جدول العامل')),
                AppBar(
